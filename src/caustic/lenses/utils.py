...
def _pix_magnification(raytrace, thx, thy, z_l, z_s, cosmology, *args, **kwargs) -> Tensor:
...
def get_magnification(raytrace, thx, thy, z_l, z_s, cosmology, *args, **kwargs) -> Tensor:
